<template>
  <div>
    ...
    <b-table :data="watchList" :loading="loading" :paginated="isPaginated" :per-page="perPage" :pagination-simple="isPaginationSimple" :total="total" @page-change="onPageChange" :striped="true" :default-sort-direction="defaultSortOrder" :default-sort="defaultSortField"
  ...
  <section class="section">
    ...
    <div class="content has-text-grey has-text-centered">
      ...
      <p>
        ...
        <b-icon icon="sentiment_very_satisfied" size="is-large">
