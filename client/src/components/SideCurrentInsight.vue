<template>
  ...
  <div  v-else class="column is-3 sideRecent">
    <div class="is-sticky">
        <nav v-if="connectedUser" class="navbar is-dark">
               <p v-if="connectedUser.lang==='EN'" id="currentInsight" class="babMenu navbar-item is-tab is-active"> Open Positions</p>
               <p v-else id="currentInsight" class="babMenu navbar-item is-tab is-active"> Positions ouvertes</p>
        </nav>
