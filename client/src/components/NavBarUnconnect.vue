                ...
                <div class="nav-item field" id="formNav1">
                    <div class="control has-icons-left" id="formNav2">
                        ...
                        <b-field>
                            <b-autocomplete
                                v-model="name"
                                :placeholder="langSelected==='EN' ?'Find a stock / crypto':'Retrouver une action / crypto'"
            ...
            <div :class="{'closedToggle':closedState ===false}" class="nav-right nav-menu" >
                ...
                <div id="menu">
                 <router-link  v-for="(link, index) in navbarLinks" :key="index" :to="link.location"
                    class='menu1' :class="{'is-active': $route.path === link.location, 'nav-item': true, 'is-tab': true }"> {{ langSelected==='EN' ? link.text : link.textfr }}
                </router-link>
                </div>
                <div class="loggiin nav-profile">
                 <div class="nav-user-profile logggin">
                    <p v-if="langSelected==='EN'" class="button buttonLogin" type="button" @click="LoginModal">Login</p>
                    <p v-else class="button buttonLogin" type="button" @click="LoginModal">Connexion</p>
