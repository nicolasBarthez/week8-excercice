<template>
   ...
   <nav class="navbar is-dark">
      <div class="babblesMenu">
            <a  @click="SignupModal" :class="{'is-active':activeItem ==='all' }" class="navbar-item is-tab babMenu">{{langSelected==="EN"?"All":"Tous"}}</a>
            <a  @click="SignupModal" :class="{'is-active':activeItem ==='insidermates'}" class="navbar-item is-tab babMenu">{{langSelected==="EN"?"Insider Mates":"Amis insiders"}}</a>
            <a  @click="SignupModal" :class="{'is-active':activeItem ==='watchlist'}" class="navbar-item is-tab babMenu">{{langSelected==="EN"?"Watch List":"Liste de suivi"}}</a>
            <a  @click="SignupModal" :class="{'is-active':activeItem ==='me'}" class="navbar-item is-tab babMenu">{{langSelected==="EN"?"My babbles":"Mes babbles"}}</a>
      </div>
  </nav>
                            ...
                            <div class="level-right">
                                ...
                                <a class="level-item has-text-grey-light">
                                    <span class="icon is-medium"><i
                                     @click="SignupModal" class="like-btn">🚀</i></span>
