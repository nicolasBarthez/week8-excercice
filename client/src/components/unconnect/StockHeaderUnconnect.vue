                           ...
                           <nav id="bandB" class="level media">
                               ...
                               <div id="bullsAndBears">
                                   <div class="mobileBandB1">
                                        <div id="BBull">
                                            <button id="Bbull" @click="SignupModal" class="button is-small is-outlined is-primary">Be Bull</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mobileBandB">
                                        <div id="BBear">
                                            <button id="Bbear" @click="SignupModal"  class="button is-small is-outlined is-primary">Be Bear</button>
                                        </div>
                                    </div>
                                </div>
                            </nav>
                            <div id='Last'>
                                <div class="level-item has-text-centered">
                                    <a @click="trend1()" :class="{'has-text-blue':activeItem ==='one',' has-text-grey-light':activeItem!='one' }" class="is-6 trend-b-b"><small >{{langSelected==='EN'?'Last 24 hours':'24 heures'}}</small></a>
                                &nbsp &nbsp <small class="is-6 has-text-grey-light trend-b-b">|</small> &nbsp &nbsp

                                    <a @click="trend7()"class="is-6 trend-b-b" :class="{'has-text-blue':activeItem ==='seven',' has-text-grey-light':activeItem!='seven'}"><small >{{langSelected==='EN'?'Last week':'7 jours'}}</small></a>
                                 &nbsp &nbsp <small class="is-6 has-text-grey-light trend-b-b">|</small> &nbsp &nbsp

                                    <a @click="trend30()"class="is-6 trend-b-b" :class="{'has-text-blue':activeItem ==='thirty',' has-text-grey-light':activeItem!='thirty'}"><small >{{langSelected==='EN'?'Last month':'30 jours'}}</small></a>
                                </div>
                            </div>
                        </div>
                    </div>
